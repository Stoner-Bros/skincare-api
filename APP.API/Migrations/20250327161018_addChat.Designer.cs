...
namespace APP.API.Migrations
{
    ...
    [Migration("20250327161018_addChat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APP.Entity.Entities.SkinTestResult", b =>
                {
                    ...
                    b.Property<int>("SkinTestAnswerId")
                        .HasColumnType("int")
                        .HasColumnName("skin_test_answer_id");
            ...
            modelBuilder.Entity("APP.Entity.Entities.Thread", b =>
                {
                    b.Property<int>("ThreadId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APP.Entity.Entities.Message", b =>
                {
                    b.HasOne("APP.Entity.Entities.Thread", "Thread")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("APP.Entity.Entities.SkinTestResult", b =>
                {
                    ...
                    b.HasOne("APP.Entity.Entities.SkinTestAnswer", "SkinTestAnswer")
                        .WithOne("SkinTestResults")
                        .HasForeignKey("APP.Entity.Entities.SkinTestResult", "SkinTestAnswerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
